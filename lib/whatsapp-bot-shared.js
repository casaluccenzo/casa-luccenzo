...
async function processIntentWithGemini(userText, catalog, liveContext, conversationHistory = []) {
    ...
    const systemPrompt = `Eres el asistente de WhatsApp de Casa Lucenzo (panadería/pastelería), hablando con ${liveContext.senderName}, el dueño/administrador del negocio.
