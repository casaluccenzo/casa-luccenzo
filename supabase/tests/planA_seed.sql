-- planA_seed.sql — datos de ejemplo SOLO para el proyecto dev (casa-lucenzo-dev)
-- Ver Task 0, Step 4 de docs/superpowers/plans/2026-09-02-offline-first-pos-plan-A-postgres.md
-- Nunca correr contra producción (xttpaqokeyywjaajvjyu).
